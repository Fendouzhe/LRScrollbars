...
@interface SMStroreHouseForShelfController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,SMNewShoppingSequenceCellDelegate,SMSequenceViewDelegate,SDCycleScrollViewDelegate>
...
@implementation SMStroreHouseForShelfController
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerNib:[UINib nibWithNibName:@"SMNewShoppingSequenceCell" bundle:[NSBundle mainBundle]] forCellWithReuseIdentifier:@"newShoppingSequenceCell"];
    [self.collectionView registerNib:[UINib nibWithNibName:@"SMProductCollectionViewCell" bundle:[NSBundle mainBundle]] forCellWithReuseIdentifier:@"productCollectionViewCell"];
    {
        //    //拿到热销商品(图片轮播器)数据
...
- (void)setupNav{
    ...
    searchButton.bounds = CGRectMake(0, 0, 22, 22);
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath{
    if (indexPath.section == 0){
        ...
        SMNewShoppingSequenceCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"newShoppingSequenceCell" forIndexPath:indexPath];
        ...
        SMProductCollectionViewCell * cell = [collectionView dequeueReusableCellWithReuseIdentifier:@"productCollectionViewCell" forIndexPath:indexPath];
