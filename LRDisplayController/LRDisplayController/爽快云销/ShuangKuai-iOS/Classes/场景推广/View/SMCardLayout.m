...
@implementation SMCardLayout

//第一个要重写的方法 设置基本的大小
- (void)prepareLayout
{
    //cell大小
    self.itemSize = CGSizeMake(210 *SMMatchWidth,348 *SMMatchHeight);
    //    self.itemSize = CGSizeMake(210, 348);
    //滑动方向
    self.scrollDirection = UICollectionViewScrollDirectionHorizontal;
    //组间四个方位间距
    if (KScreenHeight == 480) {
        self.sectionInset = UIEdgeInsetsMake(10.0, 20, 10.0, 20);
    }else{
