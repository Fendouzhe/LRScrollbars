//
//  LocalUser1+CoreDataProperties.h
//  ShuangKuai-iOS
//
//  Created by 宇中 on 16/3/1.
...
@interface LocalUser1 (CoreDataProperties)
...
@property (nullable, nonatomic, retain) LocalConversation *conversatiponShip;
